...
void FusedQuantizeDequantizeLasx(
    const float* src,
    float* dst,
    int len,
    const TensorQuantizationParams& qparams,
...
template <
    ...
    bool DIRECT = false>
FBGEMM_API void requantizeOutputProcessingLasx(
    std::uint8_t* out,
...
FBGEMM_API void requantizeOutputProcessingGConvLasx(
    std::uint8_t* out,
    const std::int32_t* inp,
    const block_type_t& block,
    int ld_out,
...
template <
    ...
    bool HAS_BIAS,
    bool FUSE_RELU>
FBGEMM_API void requantizeForFloatLasx(
    float* out,
    const std::int32_t* inp,
    const block_type_t& block,
    int ld_out,
