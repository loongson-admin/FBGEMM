...
void gemmkernel_Lasx_fp16_fA0fB0fC0(
    GemmParamsFP16* gp,
...
void NOINLINE gemmkernel_1x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 1);
}
void NOINLINE gemmkernel_2x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 2);
}
void NOINLINE gemmkernel_3x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 3);
}
void NOINLINE gemmkernel_4x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 4);
}
void NOINLINE gemmkernel_5x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 5);
}
void NOINLINE gemmkernel_6x2_Lasx_fp16_fA0fB0fC0(GemmParamsFP16* gp) {
  gemmkernel_Lasx_fp16_fA0fB0fC0(gp, 6);
}
